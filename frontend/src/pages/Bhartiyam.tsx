...
export default function BhartiyamPage() {
    ...
    /**
     * ✅ FIX FOR TS2322: 
     * Filter conversations to ensure only those with a valid string _id 
     * are passed to the sidebar. This aligns with the expected type 
     * { _id: string; title: string }[]
     */
    const validHistory = useMemo(() => {
        return conversations
            .filter((chat) => typeof chat._id === "string")
            .map((chat) => ({
